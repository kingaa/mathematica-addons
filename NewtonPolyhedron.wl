...
Support::usage = "Support[f,x] gives the multi-indices of the monomials appearing in f with nonzero coefficient."

NewtonPolyhedron::usage = "NewtonPolyhedron[f,x] gives a list {U,V}, where U is a list of the vertices of the Newton polyhedron, and V is a list of vectors forming the normal cone."
