...
(* This is the package Idealize for computational algebraic geometry. *)
(* Author: Aaron A. King <kingaa at umich dot edu> *)

BeginPackage["Idealize`", {"Taylor`"}]

Unprotect[
   Ideal, Idealize, IdealSum, IdealProduct, IdealQuotient,
...
Idealize::usage = "Idealize[F, vars] computes a Groebner basis for the ideal generated by the polynomials in F in the ring k[vars].";
...
Idealize[F_List, X_List, opts___] :=
   Ideal[GroebnerBasis[F,X,opts],X,opts]
